...
| **Ancient AI / Queen Althea** | `Sarah` | `EXAVITQu4vr4xnSDxMaL` | **Royal Ancestral Hologram / Ancient Construct**<br>Mature, regal, enigmatic maternal voice of House Vanguard. | `stability: 0.60`<br>`similarity: 0.85` |
