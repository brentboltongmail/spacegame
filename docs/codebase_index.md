...
*   initCapitalShipSpinalBeams() / updateTitanExcavationAndTractorBeams() - Multi-layer spinal beam arrays on all 5 capital dreadnoughts driving a 4-phase cinematic sequence:
    1. Phase 0: Dark-Energy Violent Purple Bombardment melting Titan's methane ice crust while the gate is hidden beneath the ice.
    2. Phase 1: Ice melts -> bombardment ceases -> huge golden precursor gate is exposed on the surface.
    3. Phase 2: Convergent Purple Graviton Tractor Beams engage and haul the golden gate off Titan into space, while Dominion secondary strikes hit *The Crest*, triggering a catastrophic multi-step fireball explosion and breaking the station apart into burning tumbling debris.
