...
*   initCapitalShipSpinalBeams() / updateTitanExcavationAndTractorBeams() - Multi-layer spinal beam arrays on all 5 capital dreadnoughts driving a 4-phase cinematic sequence:
    ...
    4. Phase 3: Golden Gate arrives in space (2x size, standing on its side) -> tractor beams cease -> dense particle slipspace event horizon vortex ignites to full intensity in preparation for the Dominion Vanguard Armada.
