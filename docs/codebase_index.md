...
*   createTitanExcavationAndGoldenGate() - Spawns the superheated molten excavation crater, fractured ice crust rim, boiling liquid methane vapor geyser particle pool, expanding planetary shockwaves, and ionization lightning on Titan's Kraken Mare. Also spawns the colossal Ancient Precursor Golden Gate ring with 12 anchor obelisks, luminous violet focus crystals, rotating runic glyph bands, and a 10,000+ dense volumetric particle wormhole vortex (inflow accretion spiral swarms, deep gravitational throat tunnel particles, and peripheral boundary energy sparks). Gate is not visible initially until ice melts.
